...
# If you load this file (using the Tcl command: source sk3e_ipbus100.tcl), then you can
...
proc add_source_files {} {
   ...
   xfile add "../src/ipbus/cern/core/ipbus_trans_decl.vhd"
   xfile add "../src/ipbus/cern/core/stretcher.vhd"
   xfile add "../src/ipbus/cern/core/trans_arb.vhd"
   xfile add "../src/ipbus/cern/core/transactor.vhd"
   xfile add "../src/ipbus/cern/core/transactor_cfg.vhd"
   xfile add "../src/ipbus/cern/core/transactor_if.vhd"
   xfile add "../src/ipbus/cern/core/transactor_sm.vhd"
   xfile add "../src/ipbus/cern/core/udp_buffer_selector.vhd"
   xfile add "../src/ipbus/cern/core/udp_build_arp.vhd"
   xfile add "../src/ipbus/cern/core/udp_build_payload.vhd"
   xfile add "../src/ipbus/cern/core/udp_build_ping.vhd"
   xfile add "../src/ipbus/cern/core/udp_build_resend.vhd"
   xfile add "../src/ipbus/cern/core/udp_build_status.vhd"
   xfile add "../src/ipbus/cern/core/udp_byte_sum.vhd"
   xfile add "../src/ipbus/cern/core/udp_clock_crossing_if.vhd"
   xfile add "../src/ipbus/cern/core/udp_do_rx_reset.vhd"
   xfile add "../src/ipbus/cern/core/udp_dualportram.vhd"
   xfile add "../src/ipbus/cern/core/udp_dualportram_rx.vhd"
   xfile add "../src/ipbus/cern/core/udp_dualportram_tx.vhd"
   xfile add "../src/ipbus/cern/core/udp_if_flat.vhd"
   xfile add "../src/ipbus/cern/core/udp_ipaddr_block.vhd"
   xfile add "../src/ipbus/cern/core/udp_packet_parser.vhd"
   xfile add "../src/ipbus/cern/core/udp_rarp_block.vhd"
   xfile add "../src/ipbus/cern/core/udp_rxram_mux.vhd"
   xfile add "../src/ipbus/cern/core/udp_rxram_shim.vhd"
   xfile add "../src/ipbus/cern/core/udp_rxtransactor_if_simple.vhd"
   xfile add "../src/ipbus/cern/core/udp_status_buffer.vhd"
   xfile add "../src/ipbus/cern/core/udp_tx_mux.vhd"
   xfile add "../src/ipbus/cern/core/udp_txtransactor_if_simple.vhd"
   xfile add "../src/ipbus/cern/ethernet/emac_hostbus_decl.vhd"
   xfile add "../src/ipbus/cern/scripts/addr_dec/ipbus_addr_decode.vhd"
   xfile add "../src/ipbus/cern/slaves/hdl/ipbus_ctrlreg.vhd"
   xfile add "../src/ipbus/cern/slaves/hdl/ipbus_ctrlreg_v.vhd"
   xfile add "../src/ipbus/cern/slaves/hdl/ipbus_fiforead.vhd"
   xfile add "../src/ipbus/cern/slaves/hdl/ipbus_reg_types.vhd"
   xfile add "../src/ipbus/wzab/clock_div.vhd"
   xfile add "../src/ipbus/wzab/ethernet/dpr_eth_receiver.vhd"
   xfile add "../src/ipbus/wzab/ethernet/dpr_eth_sender.vhd"
   xfile add "../src/ipbus/wzab/ethernet/dpram_inf_scl.vhd"
   xfile add "../src/ipbus/wzab/ethernet/eth_s3e_100mii.vhd"
   xfile add "../src/ipbus/wzab/ethernet/pkg_newcrc32_d4.vhd"
   xfile add "../src/ipbus/wzab/slaves.vhd"
   xfile add "clk_ipb100.xaw"
   xfile add "pkt_fifo.xco"
...
proc set_process_props {} {
   ...
   project set "Work Directory" "/home/xl/ise_projects/ise_projects/ether_fpga_txt_new/FPGA/sk3e/xst" -process "Synthesize - XST"
